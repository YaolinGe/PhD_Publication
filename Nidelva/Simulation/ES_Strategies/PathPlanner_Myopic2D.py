...
class MyopicPlanning_2D:
    ...
    def find_candidates_loc(self):
        self.ind_middle_layer = np.where(self.knowledge.xyz_wgs[:, 2] == np.mean(self.knowledge.xyz_wgs[:, 2]))[0]
        self.coordinates_middle_layer = self.knowledge.xyz_wgs[self.ind_middle_layer, :]
