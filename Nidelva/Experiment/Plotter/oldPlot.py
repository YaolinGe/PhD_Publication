...
from usr_func_ex import *

# == load data ==
circumference = 40075000
datapath = "/Users/yaoling/OneDrive - NTNU/MASCOT_PhD/Publication/Nidelva/Experiment/Data/Data/"
...
mu_prior = np.loadtxt(datapath+"mu_prior_sal.txt").reshape(-1, 1)
...
# for i in range(200, 400):
    ...
    plotly.offline.plot(fig, filename=figpath+"experiment.html", auto_open=False)
    os.system("open -a \"Google Chrome\" /Users/yaoling/OneDrive\ -\ NTNU/MASCOT_PhD/Publication/Nidelva/fig/Experiment/experiment.html")
